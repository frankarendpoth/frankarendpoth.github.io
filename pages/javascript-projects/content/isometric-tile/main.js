  ...
  function render() {
    ...
    for (var r = 0; r < rows; r ++) {
      ...
      for (var c = 0; c < columns; c ++) {
        ...
        display.drawTile(c * tile_width + (r & 1) * tile_width * 0.5,
          
        max_height - current_height + (r * tile_depth * 0.5 - game.world.getTiltedHeight(game.world.height_map[row_value + c])),
